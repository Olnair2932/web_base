...
<div class="float-group">
    ...
    <button id="shareBtn" class="float-btn" onclick="compartilhar()">🔗</button>
    <button id="topBtn" class="float-btn" onclick="window.scrollTo({top: 0, behavior: 'smooth'})">↑</button>
</div>
...
sed -i 's/#Limpador/#Limpador/g' /data/data/com.termux/files/home/ia_termux/arsenal/scripts/web_base/nexus_limpar.sh
